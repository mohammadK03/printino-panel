...
import nuxt_plugin_datetime_56cd4766 from 'nuxt_plugin_datetime_56cd4766' // Source: ..\\plugins\\datetime.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"سامانه مدیریت پرینتینو","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (process.client && typeof nuxt_plugin_otp_48133c3c === 'function') {
    await nuxt_plugin_otp_48133c3c(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_datetime_56cd4766 === 'function') {
    await nuxt_plugin_datetime_56cd4766(app.context, inject)
  }

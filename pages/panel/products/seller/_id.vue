      ...
      >
        <template v-slot:top>
          ...
          >
            <div class="d-flex flex-column">
              ...
              <span
                style="
                  ...
                  color: #2d3436;
                "
                >تمامی ‌محصولات شما دراین صفحه نمایش داده می‌شود
              </span>
            </div>
            <div>
              <v-text-field
            ...
            <!-- <div>
              <v-btn rounded dark color="#2b4a83" :to="'/panel/create-product/'">
                <v-icon>add</v-icon>
          ...
          <v-menu top offset-x>
            ...
            <v-list>
              <v-list-item>
                ...
                <div>
                  <v-btn class="ma-1 remove-space" outlined @click="deleteProduct(item)">
...
export default {
  ...
  data() {
    return {
      ...
      LastNameRules: [
        (v) => (v && v.length <= 20) || "نام خانوادگی  باید کمتر از 20 نویسه باشد",
  ...
  methods: {
    ...
    async getProducts(page) {
      ...
      try {
        let data = await this.$axios.$get(url + `api/products?page=${page}&seller=${id}`, {
          headers,
        });
        console.log(data);
